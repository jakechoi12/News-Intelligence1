...
**구체적 키워드 추출 우선순위**
1. 고유명사 (회사명, 항만명, 국가/지역명)
   - 예: Maersk, 부산항, Red Sea, Panama Canal
2. 복합 키워드 (명사구)
   - 예: "운임 인상", "항만 파업", "배터리 공급망"
3. 이슈 키워드 (사건/현상)
   - 예: "체선 심화", "통관 지연", "관세 분쟁"
...
마우스 오버 시 AI가 분석한 **무역/물류/SCM 관점의 시사점** 표시:
...
├─────────────────────────────────────────────────────┤
│ 💡 시사점                                            │
│ • 무역: 아시아-유럽 항로 운송 비용 20% 상승 예상    │
│ • 물류: 희망봉 우회로 인한 리드타임 7-10일 증가    │
│ • SCM: 안전재고 확대 및 복수 항로 확보 필요        │
└─────────────────────────────────────────────────────┘
```

* 각 헤드라인에 3개의 bullet point로 시사점 표시
